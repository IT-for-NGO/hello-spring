...
CIRCLE_SHA1=$(shasum target/go-sample-webapp-1.0-SNAPSHOT.jar | cut -b-40)
...
push_ecr_image(){
    ...
    docker tag $AWS_ACCOUNT_ID.dkr.ecr.us-east-1.amazonaws.com/go-sample-webapp:latest $AWS_ACCOUNT_ID.dkr.ecr.us-east-1.amazonaws.com/go-sample-webapp:$CIRCLE_SHA1 
